...
router.get("/getType", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, type_model_1.TypeModel.countDocuments()];
            case 1:
...
router.get("/", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, type_model_1.TypeModel.find()];
            case 1:
                products = _a.sent();
                res.send(products);
                return [2 /*return*/];
...
router.get("/getProductbyIdType/:idType", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var idType, Products;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                idType = req.params.idType;
                return [4 /*yield*/, product_model_1.ProductModel.find({ MaTieuMuc: idType })];
            case 1:
                Products = _a.sent();
                res.send(Products);
                return [2 /*return*/];
